...
### 🔥 Firebase + 🐙 GitHub (Base de Datos híbrida)
- **Doble respaldo**: todo se guarda en Firebase Realtime Database Y en GitHub
- Si uno falla, el otro funciona (máxima seguridad para tus recuerdos)
- **Sin límite de almacenamiento** (GitHub repos ilimitados + Firebase)
- **100% gratis** (plan Spark de Firebase + GitHub gratuito)
- Los archivos se guardan como base64 dentro de los datos
...
│   ├── firebase.js     # Conexión con Firebase (base de datos)
...
```
┌─────────────────────────────────────────────────┐
│  CLOUD (doble base de datos)                     │
│  🐙 GitHub: info/datos.json en el repositorio    │
...
- **Firebase**: backup automático en Realtime Database (plan gratuito Spark)
