...
### Opción 3: Sincronización entre dispositivos (sin tokens)
1. Crea un repositorio **privado** en GitHub
2. Sube todos los archivos del proyecto (incluyendo la carpeta `info/`)
3. Activa **GitHub Pages** en el repositorio:
   - Ve a **Settings → Pages**
   - Selecciona la rama `main` y guarda
   - Espera 1-2 minutos
4. Tu página estará en: `https://TU_USUARIO.github.io/NOMBRE_DEL_REPO/`
5. En la página, ve a **⚙️ Ajustes → GitHub Pages**
6. Pega la URL de tu página de GitHub Pages
7. Haz clic en **Guardar y Cargar Datos**
8. La página cargará los datos guardados en `info/datos.json` del repositorio
9. Repite esto en cada dispositivo (celular, computadora) para ver los mismos datos
10. Para compartir nuevos datos, usa **Exportar Datos** y **Importar Datos** en Ajustes
...
├── info/
│   └── datos.json      # 📊 TODOS los datos se guardan aquí en GitHub
...
Todos los datos (cartas, anécdotas, historias, chat) se guardan directamente en el archivo **`info/datos.json`** de tu repositorio de GitHub. Esto significa que:

- **Cuando subes algo** → se guarda directamente en GitHub
- **Cuando abres la página** → carga los datos desde GitHub
- **Ambos dispositivos** (celular y computadora) ven la misma información
- **Los archivos adjuntos** (fotos, audios, videos) se guardan localmente en cada dispositivo y sus metadatos en GitHub
