...
- Generan enlaces permanentes (CID) que nunca se pierden (no pertenece a ninguna empresa)
...
└─────────────────────────────────────────────────┘
                    ↓
┌─────────────────────────────────────────────────┐
│  FIREBASE STORAGE (archivos hasta 10MB)          │
│  - 🖼️ Fotos, 🎬 videos, 🎵 audios                │
│  - 10 MB límite por archivo                       │
...
- **Firebase Storage**: fotos, videos, audios (hasta 10MB cada uno)
...
2. **Usa Firebase Storage** para fotos/videos: hasta 10MB cada uno
