...
const Storage = (function() {
  ...
  async function syncWithGithub() {
    ...
    const filePath = 'data/panquesito-data.json';

    try {
      // Obtener datos actuales
      const localData = loadData();

      // Intentar obtener los datos remotos
      let remoteData = null;
      let remoteSha = null;
      ...
      try {
        ...
        // No existe el archivo remoto, se creará
      }
      ...
      // Guardar los datos fusionados localmente
      saveData(merged);
